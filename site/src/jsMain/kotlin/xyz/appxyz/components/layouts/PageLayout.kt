...
@Composable
private fun CobwebGraphic(modifier: Modifier) {
    // Make this a *little* brighter as it is otherwise hard to see
    val color = ColorMode.current.toPalette().nearBackground.shifted(0.05f)
    ...
    Svg(attrs = modifier.toAttrs {
        ...
        Defs {
            ...
            RadialGradient("cobweb-fade-out", attrs = {
                cx(0)
                cy(0)
                r(120.percent)
            }) {
...
fun PageLayout(title: String, content: @Composable ColumnScope.() -> Unit) {
    ...
    Box(
        ...
        CobwebGraphic(Modifier.gridRow(1).align(Alignment.TopStart))
        Column(
